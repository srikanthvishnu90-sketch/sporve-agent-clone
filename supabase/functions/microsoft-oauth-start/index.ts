    ...
    return await withHttpDeadline(async signal => {
      ...
      if (!allowed.includes(kind)) {
        /* Grandfather (owner 2026-09-21): re-consent repairs a grant this org
           ...
           ever stores a real secret in the vault. Without this, a dead grant
           on a connector outside the current plan (e.g. a Pro org's
           Microsoft 365 connection) can never be repaired from the UI: the
           tile offers Reconnect, the start call 402s, and the button dies. */
