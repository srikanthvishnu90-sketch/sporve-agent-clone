  ...
  function billingView() {
    ...
    if (active === "plan") {
      ...
      /* DEDICATED CANCELLATION PAGE. A Sporv-native subscription management
         view: shows the current plan and offers a clear, confirmed cancel
         path that calls billing-cancel. No redirect to Stripe required. */
      body = ui.Block({
        title:"Subscription",
        ...
        body: st.entitled
          ? ui.ListCard([
            ...
            '<h3 style="margin:0 0 8px;font-size:16px;">Cancel subscription</h3>' +
            '<p style="margin:0 0 16px;color:#666;font-size:14px;">Cancelling stops future charges immediately. You keep Pro until the end of the current billing period, then your workspace returns to the Free plan.</p>' +
